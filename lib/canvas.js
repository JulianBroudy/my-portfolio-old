...
function updateCanvasSize() {
  ...
  for (let i = 0; i < numberOfPoints; i++) {
    var point = new Vector(Math.random() * radious - Math.random() * radious, Math.random() * radious - Math.random() * radious, Math.random() * radious - Math.random() * radious);
