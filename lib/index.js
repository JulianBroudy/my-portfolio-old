...
// document.getElementById("im_intrigued").addEventListener("click", function(){
//   fullpage_api.moveTo('myProjects', 1);
// });

// $(document).on('click', '#moveTo', function(){
//   fullpage_api.moveTo('myProjects', 2);
// });
...
function translate() {
  ...
  timeline.from(".section1__container__header", {
    ...
    // delay: 0.5
  }, "<5").from("#welcome_text-second_line", {
    // y: -100,
    yPercent: 500,
    scale: 0,
    opacity: 0,
